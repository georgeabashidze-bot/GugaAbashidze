...
export const translations = {
  en: {
    ...
    hero: {
      ...
      titleA: 'Routine Feeding =',
      titleB: 'Happy and Healthy Pet',
      sub: 'Register — choose your products — choose delivery dates, and we’ll do the rest. You’ll never forget, never run out of your pet’s products, and you won’t pay anything extra for regular deliveries.',
  ...
  ka: {
    ...
    hero: {
      ...
      titleA: 'რეგულარული კვება =',
      titleB: 'ბედნიერი და ჯანმრთელი ცხოველი',
      sub: 'დარეგისტრირდი — აირჩიე პროდუქცია — აირჩიე მიწოდების თარიღები, დანარჩენი ჩვენი საქმეა. არასოდეს დაგავიწყდება, არ ამოგეწურება და დამატებითს არაფერს გადაიხდი რეგულარულ მიწოდებაში.',
