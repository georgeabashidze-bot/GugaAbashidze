...
export const translations = {
  en: {
    ...
    contact: {
      seoTitle: 'Contact — talk to a real human',
      seoDescription: 'Get in touch with SmartPaw Food in Tbilisi. WhatsApp +995 591 96 99 01, guga@smartpaw.ge, or pick a department and send a message.',
      eyebrow: 'Contact',
      ...
      mapTitle: 'SmartPaw Food, Tbilisi',
      form: {
        eyebrow: 'Send a message',
        title: 'For everything that isn’t a quick WhatsApp.',
        body: 'Partnerships, wholesale enquiries, press, careers or anything else. Pick the right team below and we’ll reply by email within one working day.',
        name: 'Your name',
        namePlaceholder: 'Ana Ramishvili',
        email: 'Email',
        emailPlaceholder: 'you@example.com',
        subject: 'Subject',
        subjectPlaceholder: 'What is this about?',
        message: 'Message',
        messagePlaceholder: 'Tell us what you need — the more context, the faster we reply.',
        submit: 'Send message',
        sending: 'Sending…',
      ...
      departments: {
        general: { title: 'Customer support', body: 'Plan questions, deliveries, brand swaps, refunds.' },
        partnerships: { title: 'Brand partnerships', body: 'Get your brand on the SmartPaw shelf or run a co-promo.' },
        press: { title: 'Press & media', body: 'Interviews, founder quotes, product imagery.' },
        careers: { title: 'Careers', body: 'Open roles in delivery, customer care and ops.' },
      },
    },
    pageShell: {
  ...
  ka: {
    ...
    contact: {
      seoTitle: 'კონტაქტი — დაგვიკავშირდი ცოცხალ ადამიანს',
      seoDescription: 'დაუკავშირდი SmartPaw Food-ს თბილისში. WhatsApp +995 591 96 99 01, guga@smartpaw.ge, ან აირჩიე დეპარტამენტი და გამოგვიგზავნე შეტყობინება.',
      eyebrow: 'კონტაქტი',
      title: 'მოდი ვისაუბროთ შენი ცხოველის რუტინაზე.',
      intro: 'WhatsApp ყველაზე სწრაფი გზაა დასაკავშირებლად. პარტნიორობის, საბითუმო ან პრესის საკითხებზე — მოგვწერე ელფოსტაზე, ან გამოგვიგზავნე ფორმა ქვემოთ.',
      labels: {
        address: 'მისამართი',
      ...
      toConfirm: '(დასადასტურებელია)',
      buttons: {
        whatsapp: 'WhatsApp-ის გახსნა',
        startPlan: 'დაიწყე გეგმა',
      },
      mapTitle: 'SmartPaw Food, თბილისი',
      form: {
        eyebrow: 'გამოგვიგზავნე შეტყობინება',
        title: 'ყველაფრისთვის, რაც სწრაფი WhatsApp-ი არ არის.',
        body: 'პარტნიორობა, საბითუმო, პრესა, კარიერა ან ნებისმიერი სხვა საკითხი. ქვემოთ აირჩიე შესაბამისი გუნდი და ერთ სამუშაო დღეში გიპასუხებთ ელფოსტით.',
        name: 'შენი სახელი',
        namePlaceholder: 'ანა რამიშვილი',
        email: 'ელფოსტა',
        emailPlaceholder: 'you@example.com',
        subject: 'თემა',
        subjectPlaceholder: 'რის შესახებაა?',
        message: 'შეტყობინება',
        messagePlaceholder: 'მოგვიყევი დეტალურად — რაც მეტი კონტექსტი, მით სწრაფი პასუხი.',
        submit: 'შეტყობინების გაგზავნა',
        sending: 'იგზავნება…',
        success: 'მივიღეთ — ერთ სამუშაო დღეში გიპასუხებთ ელფოსტით. გადაუდებელი საკითხისთვის — WhatsApp.',
        error: 'შეტყობინება ვერ გავიდა — სცადე WhatsApp-ით.',
        missing: 'გთხოვ, შეავსე ყველა ველი გაგზავნამდე.',
        routedTo: 'მიემართება:',
      },
      departments: {
        general: { title: 'მომხმარებლის მხარდაჭერა', body: 'გეგმის შეკითხვები, მიწოდება, ბრენდის ცვლა, დაბრუნება.' },
        partnerships: { title: 'ბრენდის პარტნიორობა', body: 'მოათავსე შენი ბრენდი SmartPaw-ის თაროზე ან მოაწყვე ერთობლივი აქცია.' },
        press: { title: 'პრესა და მედია', body: 'ინტერვიუები, დამფუძნებლის ციტატები, პროდუქტის ფოტოები.' },
        careers: { title: 'კარიერა', body: 'ღია ვაკანსიები მიწოდებაში, მომხმარებლის მხარდაჭერასა და ოპერაციებში.' },
      },
    },
    pageShell: {
