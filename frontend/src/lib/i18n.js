...
export const translations = {
  en: {
    ...
    why: {
      ...
      body: 'A subscription that handles the schedule, the stock and the doorstep — and ships every plan with a free programmable smart-dispenser that portions meals on time, every time.',
      badges: ['Free Delivery', 'Free Food Dispenser', '<24h Same-day Delivery', 'Cancel Any Time'],
    },
    how: {
  ...
  ka: {
    ...
    why: {
      ...
      title: 'შენი ცხოველის გარშემო აწყობილი.',
      body: 'სააბონენტო, რომელიც ზრუნავს გრაფიკზე, მარაგზე და მიწოდებაზე — და ყველა გეგმას ემატება უფასო პროგრამირებადი ჭკვიანი ფიდერი.',
      badges: ['უფასო მიწოდება', 'უფასო ფიდერი', 'იმავე დღის მიწოდება', 'გააუქმე ნებისმიერ დროს'],
    },
    how: {
